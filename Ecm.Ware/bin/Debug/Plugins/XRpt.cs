...
namespace Ecm.Reports.Plugins
{
    ...
    /// </summary>
    public class XRpt : IPlugin
    {

        bool DataLoaded = false;
        #region Forms

         GoobizFrame.Windows.Forms.FormXReport objFormReport;
            ...
            switch (formName)
            {
                ...
                default:
                    if (objFormReport == null || objFormReport.IsDisposed)
                        objFormReport = new  GoobizFrame.Windows.Forms.FormXReport();
                    XtraReports.XRpt_Designing objXRpt_Designing = new Ecm.Reports.XtraReports.XRpt_Designing();
                    objXRpt_Designing.xrLabel1.Text = formText;

                    objFormReport.printControl1.PrintingSystem = objXRpt_Designing.PrintingSystem;
                    objXRpt_Designing.CreateDocument();
                    objFormReport.Report = objXRpt_Designing;
