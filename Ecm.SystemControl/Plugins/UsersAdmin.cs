...
namespace Ecm.SystemControl.Plugins
{
	...
	/// </summary>
	public class UsersAdmin : IPlugin
	{


        #region Forms
        //Ecm.ADUsers.Forms.ActiveDirectoryLogon activeDirectoryLogon;
        #endregion
        ...
        public void BarManager_ItemClick(object sender, EventArgs e)
        {
            ...
            switch (formName)
            {
                case "ActiveDirectoryLogon":
                     GoobizFrame.Windows.MdiUtils.MdiChecker.NotifyLogon.NotifyAfterLogout();

                        //show form logon
                    Ecm.SystemControl.UsersAdmin.Logon.ShowDatabaseLogon(this.mdiParent);
                    break;
                case "ShutDown":
