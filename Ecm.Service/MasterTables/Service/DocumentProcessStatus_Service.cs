...
namespace Ecm.Service.MasterTables.Service
{
    public class DocumentProcessStatus_Service
    {
        ...
        public string GetRole_System_Name_ById_User(object Id_User)
        {
            ...
            {
                System.Data.DataSet dsCollection = new DataSet();
                System.Data.OleDb.OleDbCommand oleDbCommand = new System.Data.OleDb.OleDbCommand("Pol_Dm_Role_Select_ByUser_Id", this._SqlConnection);
                oleDbCommand.CommandType = CommandType.StoredProcedure;
                oleDbCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("@Id_User", Id_User));
