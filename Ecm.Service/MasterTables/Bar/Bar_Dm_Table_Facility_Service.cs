...
{
    public class Bar_Dm_Table_Facility_Service
    {
        ...
        #region Method
        public Bar_Dm_Table_Facility_Service(System.Data.OleDb.OleDbConnection sqlMaper)
        {
        ...
        public string Get_All_Bar_Dm_Table_Facility_Collection(object Id_Table)
        {
            ...
            System.Data.OleDb.OleDbCommand oleDbCommand = new System.Data.OleDb.OleDbCommand("Bar_Dm_Table_Facility_Selectall", this._SqlConnection);
        ...
        public object Update_Bar_Dm_Table_Facility_Collection(DataSet dsCollection)
        {
            try
            {
                System.Data.OleDb.OleDbDataAdapter oleDbDataAdapter = new System.Data.OleDb.OleDbDataAdapter("select * from Bar_Dm_Table_Facility", _SqlConnection);
                ...
                {
                    _Sys_Service.Update_Sys_Lognotify("Bar_Dm_Table_Facility", DateTime.Now);
                }
                return true;
            }
            catch (Exception ex)
