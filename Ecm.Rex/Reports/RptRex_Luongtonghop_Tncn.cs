...
{
    public partial class RptRex_Luongtonghop_Tncn : DevExpress.XtraReports.UI.XtraReport
    {
        public RptRex_Luongtonghop_Tncn()
        {
            InitializeComponent();
        }
        ...
        private void ReportFooter_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            this.xrTableCell_Tienbangchu.Text = GoobizFrame.Windows.HelperClasses.ReadNumber.ChangeNum2VNStr(
                Convert.ToDouble("0" + ds.Tables[0].Compute("sum(Tncn)", ""))
                , " đồng"
                );
        }
