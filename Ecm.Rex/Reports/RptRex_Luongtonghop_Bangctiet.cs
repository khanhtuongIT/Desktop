...
{
    public partial class RptRex_Luongtonghop_Bangctiet : DevExpress.XtraReports.UI.XtraReport
    {
        public RptRex_Luongtonghop_Bangctiet()
        {
            InitializeComponent();
        }
        ...
        private void ReportFooter_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                this.xrTableCell_Tienbangchu.Text = GoobizFrame.Windows.HelperClasses.ReadNumber.ChangeNum2VNStr(
                    Convert.ToDouble(ds.Tables[0].Compute("sum(Thuclanh)", ""))
                    , " đồng"
                    );
            ...
            {
                GoobizFrame.Windows.TrayMessage.TrayMessage.Status = new GoobizFrame.Windows.TrayMessage.TrayMessageInfo(System.Windows.Forms.MessageBoxIcon.Asterisk, ex.Message, ex.ToString());
            }
        }
